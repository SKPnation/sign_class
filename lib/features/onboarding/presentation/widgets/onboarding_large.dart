...
class OnboardingLarge extends StatelessWidget {
  const OnboardingLarge({super.key, required this.onboardingController, required this.onSwitchRecognizer, required this.studentController});
