...
class StudentOnboardingLarge extends StatefulWidget {
  const StudentOnboardingLarge({super.key});

  @override
  State<StudentOnboardingLarge> createState() => _StudentOnboardingLargeState();
}

class _StudentOnboardingLargeState extends State<StudentOnboardingLarge> {
